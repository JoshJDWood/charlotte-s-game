...
private:
	//family specific
	int selfindex = 10;
	static constexpr int nDestinations = 11;
	Vec2 Destinationloc[nDestinations] = { {21,2}, {18,8}, {21,15}, {8,14}, {4,14}, {6,1}, {15,1}, {2,2},
		{2,9}, {8,14}, {21,7} };
	Vec2 Destinationfloor[nDestinations] = { {0,2}, {0,3}, {0,5}, {0,6}, {0,6}, {1,0}, {1,0}, {2,0},
		{2,0}, {3,0}, {3,0} };
